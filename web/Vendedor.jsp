<%-- 
    Document   : Vendedor
    Created on : 30 dic. 2021, 02:22:57
    Author     : Usuario
--%>
...
<html>
  ...
  <div class="container">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a style= " margin-left: 10px; border:none" class="btn btn-outline-light" href="Controlador?menu=Devoluciones" target="myFrame">Devoluciones</a>
      </li>
       <li class="nav-item">
  ...
  <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
    ...
    <p class="dropdown-item" href="#">${usuario.getNombreUsuario()}</p>
